...
Basing on our experiments, the initial configurations that generate a black surface expanding
evolution are those where small active blocks are connected together via segments.
\end{proposition}
