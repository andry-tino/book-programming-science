...
\end{align*}
Of course, that is not the exacrt number, as we have simplified things by considering one month always
...
And here come the final question: how does the state of a cell change? This is where its
