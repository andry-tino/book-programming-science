...
$s \in \mathcal{A}$ which is an element of the alphabet; this means that the set of states
...
unit-radius neighborhood ($r=1$). So, from now on we will always implicitely consider:
