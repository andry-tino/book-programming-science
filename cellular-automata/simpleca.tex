...
\subsection{Playing with Conway's Game of Life automaton}
There is a reason if we have decided to build this specific automaton as our first CA! Other than being
the very first one to be published, other than being very famous, it has some very interesting properties.
