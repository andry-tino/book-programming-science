...
provided as input. Now our code is finished and we can refresh the page to see our CA getting an initial
condition.

\begin{problem}
\label{prob:changeinit}
Change the initial condition of the grid to set as on only cells: $(3,1)$, $(1,3)$ and $(4,4)$.
\end{problem}
